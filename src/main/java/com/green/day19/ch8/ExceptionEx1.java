...
class ExcetptionEx1_3 {
    public static void main(String[] args) {
        try {
            /*ExcetptionEx1_3 obj = null;
            obj.sum();*/
            int[] arr = new int[10];
            arr[10] = 10;
        } catch (ArithmeticException | ArrayIndexOutOfBoundsException e) {       //특정한 예외만
            e.printStackTrace();
            System.out.println("수학적 예외");
        } catch (NullPointerException e) {
            System.out.println("널포인트 예외");  //  특정한 예외만
        } catch (Exception a) {
